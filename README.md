...
<p align="center">
  <strong>Быстрые голосовые заметки для macOS</strong>
</p>
...
<p align="center">
  Нативное macOS приложение для мгновенного голосового ввода с real-time транскрибацией.<br>
  Вызывай хоткеем → диктуй → текст автоматически вставляется в любое приложение.
</p>
...
### Удобство
- **История заметок** — последние 50 записей с поиском
...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  Привет, это тестовая заметка которую я диктую...      │
│                                                         │
├─────────────────────────────────────────────────────────┤
│  [История ▾]      [Текст]      [Отправить ↵]           │
└─────────────────────────────────────────────────────────┘
```
...
- **Deepgram API Key** (бесплатный tier: 200 часов/мес)
...
<p align="center">
  Made with ❤️ for fast voice input on macOS
</p>
