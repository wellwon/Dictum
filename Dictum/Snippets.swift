...
#Preview("SnippetRowView") {
    VStack(spacing: 0) {
        SnippetRowView(
            snippet: Snippet.create(shortcut: "addr", title: "Домашний адрес", content: "ул. Пушкина, д. 10"),
            onToggleFavorite: {},
            onEdit: {},
            onDelete: {},
            onInsert: {}
        ...
        SnippetRowView(
            snippet: Snippet.create(shortcut: "sig", title: "Подпись", content: "С уважением, Иван"),
            onToggleFavorite: {},
            onEdit: {},
            onDelete: {},
            onInsert: {}
